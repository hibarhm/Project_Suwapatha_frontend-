...
export default function Home() {
  return (
    <main className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div className="space-y-5">
              <h1 className="text-4xl lg:text-5xl font-bold leading-tight">
                Seamless Healthcare,{' '}
                <span className="text-indigo-700">Simplified for You</span>
              </h1>
      ...
      {/* Features Section */}
      <section className="bg-indigo-900 py-16 px-6 relative overflow-hidden">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <a href="mailto:info@suwapatha.gov.lk" className="text-gray-700 hover:text-indigo-700 transition-colors">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href="tel:+94112345678" className="text-gray-700 hover:text-indigo-700 transition-colors">
                    +94 11 234 5678
                  </a>
                </div>
              </div>
