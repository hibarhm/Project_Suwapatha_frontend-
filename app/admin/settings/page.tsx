      ...
      <div className="p-8 max-w-5xl mx-auto space-y-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8">
          ...
          <div className="flex justify-end">
            <button className="px-6 py-2.5 bg-[#94B4C1] text-white rounded-lg text-sm font-medium hover:bg-[#7fa8b8] transition-colors">
              Save Changes
            </button>
          </div>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start justify-between py-3">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#94B4C1] focus:ring-offset-2 ${
                  notifications.email ? 'bg-[#94B4C1]' : 'bg-gray-300'
                }`}
              >
                <span
            ...
            <div className="flex items-start justify-between py-3">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#94B4C1] focus:ring-offset-2 ${
                  notifications.sms ? 'bg-[#94B4C1]' : 'bg-gray-300'
                }`}
              >
                <span
                  className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
            ...
            <div className="flex items-start justify-between py-3">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#94B4C1] focus:ring-offset-2 ${
                  notifications.push ? 'bg-[#94B4C1]' : 'bg-gray-300'
                }`}
              >
                <span
                  className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
