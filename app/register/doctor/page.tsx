          ...
          <div className="grid lg:grid-cols-2 gap-6 items-start">
            ...
            <div className="bg-white rounded-xl border-2 border-gray-200 p-6 lg:p-8 shadow-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-indigo-700 text-white py-3 rounded-lg font-semibold hover:bg-indigo-800 transition-colors shadow-md hover:shadow-lg text-sm mt-2"
                >
                  Register as Doctor
                </button>
                ...
                <p className="text-center text-sm text-gray-600 pt-1">
                  Already registered?{' '}
                  <Link href="/login/doctor" className="text-indigo-700 hover:text-indigo-800 font-medium">
                    Log in
                  </Link>
                </p>
              </form>
