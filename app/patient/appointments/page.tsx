          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-xl p-8 mb-6">
              <div className="text-center mb-6">
                ...
                <p className="text-6xl font-bold text-indigo-700">15</p>
              </div>
            ...
            <button className="w-full flex items-center justify-center gap-2 bg-indigo-700 hover:bg-indigo-800 text-white font-medium py-3 px-6 rounded-lg transition-colors">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
