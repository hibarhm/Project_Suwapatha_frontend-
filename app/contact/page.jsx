    ...
    <main className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 left-0 right-0 bg-white z-50 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <button className="bg-indigo-700 text-white px-6 py-2.5 rounded-lg font-medium hover:bg-indigo-800 transition-colors shadow-sm">
            Get Started
          </button>
        </div>
      </nav>
        ...
        <div className="max-w-2xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:border-indigo-700 focus:ring-1 focus:ring-indigo-700 text-gray-900 placeholder-gray-400 text-sm transition-colors"
                  required
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="6"
                  className="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:border-indigo-700 focus:ring-1 focus:ring-indigo-700 text-gray-900 placeholder-gray-400 text-sm resize-none transition-colors"
                  required
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-indigo-700 hover:bg-indigo-800 text-white font-medium py-3 px-6 rounded-lg transition-colors shadow-sm"
              >
                Send Message
              </button>
            </form>
          ...
          <div className="mt-12 text-center space-y-3">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-sm">
              <a href="mailto:info@suwapatha.gov.lk" className="flex items-center gap-2 text-gray-700 hover:text-indigo-700 transition-colors">
              ...
              <a href="tel:+94112345678" className="flex items-center gap-2 text-gray-700 hover:text-indigo-700 transition-colors">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
